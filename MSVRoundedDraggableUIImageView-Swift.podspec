#
# Be sure to run `pod lib lint MSVRoundedDraggableUIImageView-Swift.podspec' to ensure this is a
...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.description      = <<-DESC
MSVRoundedDraggableUIImageView-Swift - simple rounded draggable UIImageView. IB designable.
                       DESC
 ...
 s.social_media_url = 'https://twitter.com/sergemoskalenko'
  ...
  s.source_files = 'MSVRoundedDraggableUIImageView-Swift/Classes/**/*'
  
  # s.resource_bundles = {
  #   'MSVRoundedDraggableUIImageView-Swift' => ['MSVRoundedDraggableUIImageView-Swift/Assets/*.png']
  # }
